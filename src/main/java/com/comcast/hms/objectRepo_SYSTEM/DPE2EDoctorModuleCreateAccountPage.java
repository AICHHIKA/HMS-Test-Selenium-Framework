...
public class DPE2EDoctorModuleCreateAccountPage extends BaseClassHMS {

	WebDriver driver;

	public DPE2EDoctorModuleCreateAccountPage(WebDriver driver) {
		this.driver = driver;
...
//	}
	...
	public void DoctorModuleCreationDetail(String docrorname, String doctorClentAddress, String doctorfee,
			String doctorContactNo, String doctorEmail, String password, String ConfirmPassword)
			throws InterruptedException {

		docNameEdt.sendKeys(docrorname);
		addressEdt.sendKeys(doctorClentAddress);
		docfeeEdt.sendKeys(doctorfee);
		docContactNumber.sendKeys(doctorEmail);
